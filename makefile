...
run:
	go run -ldflags "-X main.build=0.0.1-dev" apis/services/sales/main.go | go run apis/tooling/logfmt/main.go
...
KIND_CLUSTER    := dlabs-starter-cluster
NAMESPACE       := sales-system
SALES_APP       := sales
AUTH_APP        := auth
BASE_IMAGE_NAME := localhost/dlabs
VERSION         := 0.0.1
